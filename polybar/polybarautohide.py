...
SCREEN_HEIGHT = 800
PERCENT_LIMIT = 40
SHOW_CMD = 'xdotool search --name Polybar windowmove --relative -- 0 30; bspc config top_padding 25'
HIDE_CMD = 'xdotool search --name Polybar windowmove --relative -- 0 -30; bspc config top_padding 0'
